...
<div class="container">	
	...
	<form action="ajouter" method="POST" class="form-horizontal">
				<div class="form-group">			
					...
					<div class="col-xs-10">
						<input name="nom"  placeholder="Nom du vin ..."  class="form-control" /> 
					</div>
				</div>
				...
				<div class="form-group">			
					...
					<div class="col-xs-10">
						<input name="millesime"  placeholder="Millesime du vin ..."  class="form-control" /> 
					</div>
				</div>
				...
				<div class="form-group">			
					...
					<div class="col-xs-10">
						<input name="quantite"  placeholder="Quantité de bouteilles ..."  class="form-control" /> 
					</div>
				</div>
				...
				<div class="form-group">			
					...
					<div class="col-xs-10">
						<select name="couleurId" class="form-control">
							<c:forEach items="${listeCoul}" var="c">
